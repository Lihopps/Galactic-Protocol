...
function util_tooltip.update_travel_gui(gui_data,platform)
    ...
    elseif platform.space_connection then
        ...
        local to=(platform.space_connection.from~=platform.last_visited_space_location and platform.space_connection.from) or platform.space_connection.to
    ...
    if gui_data then
        ...
        gui_data.platform_data.platform_damage.caption={"",{"description.damage"}," : ",format.number(util_math.sum_array(platform.damaged_tiles,"damage"),true,3)}
