...
---@param type string : light or heavy (juste one type per space-location)
function gp_add_gazeous_field(type,name)
...
function gp_create_planet_sprite_prototype(planet,planet_overrides)
