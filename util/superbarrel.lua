...
local technology_name = "gp-superbarrel"
-- The base empty barrel item
local empty_barrel_name = "storage-tank"
local enabled = lihop_debug

-- Item icon masks
local barrel_hoop_top_mask ="__zzz-GalacticProtocol__/graphics/icons/storage-tank.png"                          

-- Recipe icon masks
local barrel_empty_icon = "__base__/graphics/icons/storage-tank.png"
local barrel_fill_top_mask ="__zzz-GalacticProtocol__/graphics/icons/storage-tank.png"                       
...
local function create_barrel_item(name, fluid, empty_barrel_item)
    local result =
    {
        type = "item",
        name = name,
        localised_name = { "item-name.filled-superbarrel", fluid.localised_name or { "fluid-name." .. fluid.name } },
...
local function create_fill_barrel_recipe(item, fluid)
    ...
    local recipe =
    {
        type = "recipe",
        name = recipe_name,
        localised_name = { "recipe-name.fill-superbarrel", fluid.localised_name or { "fluid-name." .. fluid.name } },
        category = "crafting-with-fluid",
        energy_required = energy_per_fill,
        subgroup = "fill-superbarrel",
        order = fluid.order,
...
local function create_empty_barrel_recipe(item, fluid)
    ...
    local recipe =
    {
        type = "recipe",
        name = recipe_name,
        localised_name = { "recipe-name.empty-filled-superbarrel", fluid.localised_name or { "fluid-name." .. fluid.name } },
        category = "crafting-with-fluid",
        energy_required = energy_per_empty,
        subgroup = "empty-superbarrel",
        order = fluid.order,
        enabled = enabled,
