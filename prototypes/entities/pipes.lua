...
plasma_pipe.minable = { mining_time = 0.1, result = "gp-plasma_pipe" }
plasma_pipe.name = "gp-plasma_pipe"
...
plasma_pipe_item.name = "gp-plasma_pipe"
...
plasma_pipe_item.place_result = "gp-plasma_pipe"
...
plasma_pipe_recipe.name = "gp-plasma_pipe"
...
plasma_pipe_recipe.results = { { type = "item", name = "gp-plasma_pipe", amount = 1 } }
...
plasma_silo.minable = { mining_time = 0.1, result = "gp-plasma_silo" }
plasma_silo.name = "gp-plasma_silo"
local x = 2.5
local y = 2.5
...
plasma_silo.pictures = {
    picture = {
        sheets = {
            {
                filename = "__zzz-GalacticProtocol__/graphics/entity/tank/plasma-tank.png",
                frames = 1,
                scale = 0.5,
                width = 512,
                height = 384,
            ...
            {
                filename = "__zzz-GalacticProtocol__/graphics/entity/tank/plasma-tank-shadow.png",
                frames = 1,
                scale = 0.5,
                width = 512,
                height = 384,
...
plasma_silo_item.name = "gp-plasma_silo"
plasma_silo_item.icon = "__zzz-GalacticProtocol__/graphics/entity/tank/plasma-tank-icon.png"
plasma_silo_item.icon_size = 64
plasma_silo_item.place_result = "gp-plasma_silo"
...
plasma_silo_recipe.name = "gp-plasma_silo"
...
plasma_silo_recipe.results = { { type = "item", name = "gp-plasma_silo", amount = 1 } }

data:extend({ plasma_silo_item, plasma_silo_recipe, plasma_silo })

local plasma_pump = table.deepcopy(data.raw["pump"]["pump"])
plasma_pump.minable = { mining_time = 0.1, result = "gp-plasma_pump" }
plasma_pump.name = "gp-plasma_pump"
plasma_pump.fluid_box["filter"] = "fusion-plasma"
for _, pipe_connection in pairs(plasma_pump.fluid_box.pipe_connections) do
    pipe_connection.connection_type = "normal"
    pipe_connection.connection_category = "fusion-plasma"
end
plasma_pump.surface_conditions = { { property = "gravity", min = 0, max = 0 } }
plasma_pump.animations = color_sprites(plasma_pump.animations, tint)

local plasma_pump_item = table.deepcopy(data.raw["item"]["pump"])
plasma_pump_item.name = "gp-plasma_pump"
plasma_pump_item.icons ={
    {
        icon=plasma_pump_item.icon,
        tint=tint
    }
} 
plasma_pump_item.icon_size = 64
plasma_pump_item.place_result = "gp-plasma_pump"
plasma_pump_item.subgroup="space-platform"
plasma_pump_item.order="f[plasma-pipe]"

local plasma_pump_recipe = table.deepcopy(data.raw["recipe"]["pump"])
plasma_pump_recipe.enabled = lihop_debug
plasma_pump_recipe.name = "gp-plasma_pump"
plasma_pump_recipe.category = "electromagnetics"
plasma_pump_recipe.ingredients={
    --{type="item",name="lihop-titan-plate",amount=20},
    --{type="item",name="lihop-electronic-circuit",amount=5},
    {type="item",name="pump",amount=2},
}
plasma_pump_recipe.results = { { type = "item", name = "gp-plasma_pump", amount = 1 } }

data:extend({ plasma_pump_item, plasma_pump_recipe, plasma_pump })