...
data:extend({
    {
        ...
        ingredients =
        {
           ...
           -- { type = "item", name = "gp-titan-plate", amount = 20 }

        },
        results = { { type = "item", name = "gp-plasma-thruster", amount = 1 } }
    },
    {
        type = "item",
        name = "gp-plasma-thruster",
        icon = "__zzz-GalacticProtocol__/graphics/icons/thruster.png",
        icon_size = 64,
        subgroup = "space-platform",
        order = "z-f[thruster]-a",
        place_result = "gp-plasma-thruster",
        stack_size = 1,
        weight = 1000 * kg
    },
    {
        ...
        max_health = 300,
        minable = { mining_time = 0.1, result = "gp-plasma-thruster" },
        ...
        min_performance = { fluid_volume = 0.01, fluid_usage = 1, effectivity = 1 },
        max_performance = { fluid_volume = 0.98, fluid_usage = 0.3, effectivity = 100 },
        ...
        oxidizer_fluid_box =
        {
            ...
            pipe_connections =
            {
                { flow_direction = "input-output", direction = defines.direction.east, position = { 1.5, -2 }, enable_working_visualisations = { "pipe-1" },connection_category = "fusion-plasma" },
                { flow_direction = "input-output", direction = defines.direction.west, position = { -1.5, 0 }, enable_working_visualisations = { "pipe-3" },connection_category = "fusion-plasma"  },
            }
        },
        ...
        graphics_set =
        {
            ...
            working_visualisations =
            {
...

                {
                    -- effect = "flicker",
                    fadeout = true,
                    animation = util.sprite_load("__zzz-GalacticProtocol__/graphics/entity/thruster/thruster-light",
                        {
                            animation_speed = 0.5,
                            frame_count = 64,
                            blend_mode = "additive",
            ...
            flame_effect =
            {
                filename = "__zzz-GalacticProtocol__/graphics/entity/thruster/thruster-flame.png",
                width = 384,
                height = 832
            },
