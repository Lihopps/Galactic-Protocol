...
local function engagement_animation()
  return {
    {
    filename = "__zzz-GalacticProtocol__/graphics/entity/harvester/harvester-engagement.png",
    priority = "high",
    width = 512,
    height = 384,
    frame_count = 24,
    ...
    {
    filename = "__zzz-GalacticProtocol__/graphics/entity/harvester/harvester-engagement-shadow.png",
    priority = "high",
    width = 512,
    height = 384,
    frame_count = 24,
...
local function working_animation()
  return {
    {
    filename = "__zzz-GalacticProtocol__/graphics/entity/harvester/harvester-working.png",
    priority = "high",
    width = 512,
    height = 384,
    frame_count = 24,
    ...
    --shift = util.by_pixel(0, -15),
     ...
     {
    filename = "__zzz-GalacticProtocol__/graphics/entity/harvester/harvester-working-shadow.png",
    priority = "high",
    width = 512,
    height = 384,
    frame_count = 24,
...
local function idle_animation()
  return {
    {
    filename = "__zzz-GalacticProtocol__/graphics/entity/harvester/harvester.png",
    priority = "high",
    width = 512,
    height = 384,
    frame_count = 1,
    ...
    {
    filename = "__zzz-GalacticProtocol__/graphics/entity/harvester/harvester-shadow.png",
    priority = "high",
    width = 512,
    height = 384,
    frame_count = 1,
...
local function pipe_connection(pipe_direction)
  return
  {
    filename = "__zzz-GalacticProtocol__/graphics/entity/harvester/harvester-pipe-" .. pipe_direction..".png",
    priority = "high",
    width = 512,
    height = 384,
    frame_count = 1,
...
data:extend({
    
    {
        ...
        ingredients =
        {
            ...
            --{ type = "item", name = "gp-titan-plate", amount = 50 },
            --{ type = "item", name = "gp-titan-rod", amount = 50 },
            --{ type = "item", name = "gp-electronic-circuit", amount = 100}

        },
        results = { { type = "item", name = "gp-harvester", amount = 1 } }
    },
    {
        type = "item",
        name = "gp-harvester",
    ...
    },
   {
    ...
    minable = {mining_time = 0.2, result = "gp-harvester"},
    max_health = 350,
    corpse = "big-remnants",
    ...
    crafting_categories = {"gp-harvesting"},
    crafting_speed = 2,
    energy_source =
    {
      type = "electric",
